...
export const data = {
  ...
  workExperience: [
    {
      organization: {
        title: "work_experience.fullstack_dev.org.title",
        website: "https://www.linkedin.com/company/bluemedlar/",
        image: bluemedlar,
      },
      position: "work_experience.fullstack_dev.position",
      startDate: "work_experience.fullstack_dev.startDate",
      endDate: "work_experience.fullstack_dev.endDate",
      location: "work_experience.fullstack_dev.location",
      description: "work_experience.fullstack_dev.description",
      workPlaceMode: "work_experience.fullstack_dev.description",
      responsabilities: [
        "work_experience.fullstack_dev.responsabilities.0",
        "work_experience.fullstack_dev.responsabilities.1",
        "work_experience.fullstack_dev.responsabilities.2",
        "work_experience.fullstack_dev.responsabilities.3",
      ],
      skills: [
        "work_experience.fullstack_dev.skills.0",
        "work_experience.fullstack_dev.skills.1",
        "work_experience.fullstack_dev.skills.2",
        "work_experience.fullstack_dev.skills.3",
      ],
      tools: [
    ...
    },
    {
      ...
      workPlaceMode: "work_experience.basic_fit.workPlaceMode",
      responsabilities: [
    ...
    {
      organization: {
        title: "work_experience.ufr_researcher.org.title",
        website: "https://uni-freiburg.de",
        image: ufr,
      },
      position: "work_experience.ufr_researcher.position",
      startDate: "work_experience.ufr_researcher.startDate",
      endDate: "work_experience.ufr_researcher.endDate",
      location: "work_experience.ufr_researcher.location",
      description: "work_experience.ufr_researcher.description",
      responsabilities: [
        "work_experience.ufr_researcher.responsabilities.0",
        "work_experience.ufr_researcher.responsabilities.1",
        "work_experience.ufr_researcher.responsabilities.2",
        "work_experience.ufr_researcher.responsabilities.3",
      ],
      skills: [
        "work_experience.ufr_researcher.skills.0",
        "work_experience.ufr_researcher.skills.1",
        "work_experience.ufr_researcher.skills.2",
        "work_experience.ufr_researcher.skills.3",
        "work_experience.ufr_researcher.skills.4",
      ],
      tools: [
        { name: "VSCode", img: vscode },
        { name: "Sheets", img: sheets },
