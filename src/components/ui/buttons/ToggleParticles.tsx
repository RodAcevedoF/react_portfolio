...
const ToggleParticlesBtn = () => {
	...
	return (
		<button
			...
			className={`group relative w-24 h-24 rounded-full bg-blue-500 text-white overflow-hidden flex items-center justify-center z-10 transition-all duration-300 hover:bg-black hover:scale-105 ${
