            ...
            {tech?.map((t) => {
              return (
                <img
                  ...
                  src={t.icon}
                  alt={t.name}
                  className='w-11 h-auto hover:translate-y-[-3px] hover:shadow-lg shadow-blue-500 transition-all duration-300 ease-in-out border-2 border-yellow-200/20 rounded-md p-1'></img>
              );
            })}
          </div>
        </div>
